        ...
        <ul class="sidebar-menu tree" data-widget="tree">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    @endcan
                    @can('vehicle_use_access')
                            <li class="{{ request()->is("admin/vehicle-uses") || request()->is("admin/vehicle-uses/*") ? "active" : "" }}">
                                <a href="{{ route("admin.vehicle-uses.index") }}">
                                    <i class="fa-fw far fa-calendar-check">

                                    </i>
                                    <span>{{ trans('cruds.vehicleUse.title') }}</span>
